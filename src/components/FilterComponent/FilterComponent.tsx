    ...
    const filtrationBody = () => {
        ...
        if (sortingTitleState === "From cheap to expensive") {
            filteredItems.sort((a, b) => {
                return (
                    (a["queensPrice"] as number) - (b["queensPrice"] as number)
                );
            });
        } else if (sortingTitleState === "From expensive to cheap") {
            filteredItems.sort((a, b) => {
                return (
                    (b["queensPrice"] as number) - (a["queensPrice"] as number)
                );
            });
        } else if (sortingTitleState === "By popularity") {
            filteredItems.sort((a, b) => {
    ...
    return (
        <div className="filter">
            <div className="filter-block categories-filter">
                ...
                <p
                    className={`category ${
                        categoriesState === "All goods" ? "active" : ""
                    }`}
                    onClick={() => handleChangeCaterogy("All goods")}
                >
                    All goods
                </p>
                <p
                    className={`category ${
                        categoriesState === "Bedding Set" ? "active" : ""
                    }`}
                    onClick={() => handleChangeCaterogy("Bedding Set")}
                >
                    Bedding Set
                </p>
                ...
                {selectedFilters.map((selectedFilter) => (
                    ...
                    >
                        <div
                            ...
                            onClick={() =>
                                handeleDeliteSelectedFilter(selectedFilter)
                            }
                        ></div>
                        {colorsObj.map((color) =>
            ...
            <div className="filter-block size-filter">
                ...
                >
                    ...
                    <div className={`arrow ${sizeMenuState}`}></div>
                </div>
                <div className={`filter-content-wrapper ${sizeMenuState}`}>
                    ...
                    <div className="checkbox-wrapper">
                        <div className="checkbox-row">
                            <input
                                ...
                                onChange={handleQueenCheckboxChange}
                            />
                        ...
                        <div className="checkbox-row">
                            <input
                                ...
                                onChange={handleKingCheckboxChange}
                            />
            ...
            <div className="filter-block color-filter">
                ...
                >
                    ...
                    <div className={`arrow ${colorMenuState}`}></div>
                </div>
                <div className={`filter-content-wrapper ${colorMenuState}`}>
                    <div className="margin"></div>
                    ...
                    <div className="checkbox-wrapper">
                        ...
                        <div className="checkbox-row">
                            <input
                                ...
                                onChange={handleBrownnCheckboxChange}
                            />
                            <label
                                className="row color-example-row"
                                htmlFor="brown"
                        ...
                        <div className="checkbox-row">
                            <input
                                ...
                                onChange={handleGrayCheckboxChange}
                            />
                            <label
                                className="row color-example-row"
                                htmlFor="Gray"
                        ...
                        <div className="checkbox-row">
                            <input
                                ...
                                onChange={handleVioletCheckboxChange}
                            />
                            <label
                                className="row color-example-row"
                                htmlFor="violet"
                        ...
                        <div className="checkbox-row">
                            <input
                                ...
                                onChange={handleBordeauxCheckboxChange}
                            />
                            <label
                                className="row color-example-row"
                                htmlFor="bordeaux"
            ...
            <div className="filter-block price-filter">
                ...
                >
                    ...
                    <div className={`arrow ${priceMenuState}`}></div>
                </div>
                <div className={`filter-content-wrapper ${priceMenuState}`}>
                    <div className="margin"></div>
                                ...
                                <input
                                    ...
                                    onKeyDown={(e) => {
                                        if (e.key === "Backspace") {
                                            if (localMaxPrice > 0) {
                                                e.preventDefault();
                                                const newMaxPrice = Math.floor(
                                                    localMaxPrice / 10
                                                );
                                                setLocalMaxPrice(
                                                    Math.max(0, newMaxPrice)
                                                );
                                            }
                                        } else if (
                                            e.key.length === 1 &&
